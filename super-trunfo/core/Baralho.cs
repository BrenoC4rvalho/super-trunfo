...
namespace super_trunfo.core
{
    class Baralho
    {
        ...
        {
            cartas.Clear();
            cartas.Add(new Carta("A1", "Castor de Andrade", 1, 2, 3, 4));
            cartas.Add(new Carta("A2", "Maninho Garcia", 2, 3, 4, 5));
            cartas.Add(new Carta("A3", "Capitão Guimarães", 3, 4, 5, 6));
            cartas.Add(new Carta("A4", "Piruinha", 7, 8, 9, 10));
            cartas.Add(new Carta("A5", "Anísio", 11, 12, 13, 14));
            cartas.Add(new Carta("A6", "Natal da Portela", 15, 16, 17, 18));
            cartas.Add(new Carta("A7", "Tio Patinhas", 19, 20, 21, 22));
            cartas.Add(new Carta("A8", "Peru", 23, 24, 25, 26));
